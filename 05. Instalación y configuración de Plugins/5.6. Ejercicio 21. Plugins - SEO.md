...
### 1. Crear una Crear una cuenta de Analytics (propiedad de Analytics)
1. Abrir la página https://analytics.google.com/
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1NzAxMTQ0OSw1MTYzMjIxNzEsNzA1Nj
