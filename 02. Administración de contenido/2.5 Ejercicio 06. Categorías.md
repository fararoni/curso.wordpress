...
Antes de agregar las entradas, desactivar los comentarios:
Ajustes \ Comentarios \ Desmarca la opción "Permitir que se publiquen comentarios en los artículos nuevos". 
...
3. Agregar la página principal del sitio
...
## 10. Abrir la primera versión del sitio y ver sus entradas

## 11. Bloquear los comentarios, en caso de que continuen mostrandose.

- Ir a Entradas > Todas las entradas.
- Seleccionar todas las entradas marcando la casilla al lado del título "Título".
En el menú desplegable de "Acciones en lote", selecciona "Editar" y haz clic en "Aplicar".
En las opciones que aparecen, busca la opción "Comentarios", selecciona "No permitir" y haz clic en "Actualizar".

![](https://i.imgur.com/vL1KB8q.png)

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MzMwMjQxMDYsLTE3ODIxMzcxNCw0OT
A0MTg1MzUsMTE0Mzg5MTA4NiwtMzEzOTgyMTYxLC0yODg3MDgy
NSwtMTA3NjE4NjgzXX0=
-->