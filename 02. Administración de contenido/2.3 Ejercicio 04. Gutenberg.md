...
Abrir la entrada en otra pestaña del navegador

Abrir la entrada en una pestaña de incognito o en otro navegador
...
Regresar la entrada a borrador
...
- Volver a editar la entrada en la página "inteligencia artificial"
![](https://i.imgur.com/TR83kMj.png)
- Observar la barra de herramientas superior derecha
![](https://i.imgur.com/EhlFOqh.png)


#### 5. Ocultar/Mostrar configuraciones de la entrada
![](https://i.imgur.com/QJPuv24.png)

#### 5. Opciones
Active todas las opciones disponibles en el botón de`Opciones`
...
S
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNjM1MTIxNzksMTQ2OTExNjYzNCwxNz
A3MDQ4MDY5LDE3NzA2OTU2MjddfQ==
-->