...
Instalar y activar el tema 'Kadence'
...
- Agregar una nota al pie que indique Presidencia.
- Resaltar el párrafo "Estrategia Digital Nacional"
- 
![](https://i.imgur.com/D7Fjbdj.png)

##### Zona 4. Trabajo con bloques (opciones)

En la mayoría de bloques, están disponibles esta herramienta.
- Seleccionar la imagen 
- Hacer un patrón a partir de esta imagen

![](https://i.imgur.com/lRLSxKE.png)

Al hacerlo un patrón, no se puede editar directamente; seleccionar "resumen de documento", hacer los cambios y volver.

**Agrupar: Seleccionar dos párrafos contiguos.**
- Se activa un nuevo conjunto de herramientas 
- Agrupar
- Acomodarlos en forma de fila y publicar
- Seleccionar la opción `Editar como HTML`

## 6. Barra de ajustes lateral derecha bloque


![](https://i.imgur.com/2lml9CN.png)

Ir a la siguiente página: https://www.gob.mx/epn/es/articulos/inteligencia-artificial-en-mexico, copiar el texto a partir del párrafo "Reconociendo...." y hasta el final del documento. Pegarlo despues del último bloque.
Agegar un Titulo "Conclusión, antes del último párrafo
![](https://i.imgur.com/7GYPr5g.png)

Convertirlo a Encabezado
![](https://i.imgur.com/qJJvjln.png)

Seleccionar este bloque. y mediante la  Barra de ajustes lateral derecha agregar una marca de anclaje HTML "Conclusion"
![](https://i.imgur.com/oBG7LMl.png)

Ir al primer párrafo y en la última palabra agregar un enlace a la marca
![](https://i.imgur.com/tDek4mV.png)




<!--stackedit_data:
eyJoaXN0b3J5IjpbNTM3MzUyODc3LDk4MTUyNDYwNSwtMTU5MT
A4OTc3OSwxMDMwMzk2OTUyLDU3Njk3ODYxNCwyMjI3OTgzNTQs
NDUwNjM1NjQ3LC0xODAxMDMzNjk0LDEzODczMjc2OTUsLTE5MD
Q2NTEwMzgsLTQ5OTEwNTYwMSwtMTcxMzQ1NDM4OSwxMzAyNjE1
MjM0LDE0MTY4NjQxMjcsMTQ2OTExNjYzNCwxNzA3MDQ4MDY5LD
E3NzA2OTU2MjddfQ==
-->